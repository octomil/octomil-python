...
Minimal Python SDK wrapper for the Octomil REST API.
...
Tag a release with `octomil-vX.Y.Z` and push the tag:

```bash
git tag octomil-v0.1.1
git push origin octomil-v0.1.1
```
