...
class TestDataClasses:
    ...
    def test_device_deployment_to_dict(self):
        dd = DeviceDeployment(
            ...
            executor="nnapi",
            quantization="fp16",
            download_url="https://cdn.octomil.io/model.tflite",
            conversion_needed=True,
            runtime_config={"threads": 4},
        )
        d = dd.to_dict()
        assert d["device_id"] == "dev-1"
        assert d["download_url"] == "https://cdn.octomil.io/model.tflite"
    ...
    def test_device_deployment_status_to_dict(self):
        ds = DeviceDeploymentStatus(
            device_id="dev-1",
            status="deployed",
            download_url="https://cdn.octomil.io/model.onnx",
            error=None,
        )
        d = ds.to_dict()
            ...
            "deployments": [
                {
                    ...
                    "executor": "coreml_npu",
                    "quantization": "int8",
                    "download_url": "https://cdn.octomil.io/model.mlmodel",
