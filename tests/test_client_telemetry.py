...
_PATCH_ROLLOUTS = patch("octomil.client.RolloutsAPI", create=True)
_PATCH_REGISTRY = patch("octomil.client.ModelRegistry", create=True)
_PATCH_API = patch("octomil.client._ApiClient", create=True)
