"""Ollama bridge — detect and resolve local ollama models for Octomil deployment."""
...
# Map ollama quantization names → Octomil equivalents
...
class OllamaModel:
    ...
    @property
    def octomil_quantization(self) -> str:
        """Map ollama quantization to Octomil equivalent."""
