...
class FeatureAligner:
    ...
    def _compute_feature_stats(
        ...
        for feature in all_features:
            ...
            if values:
                ...
                self.feature_stats[feature] = {"mean": 0.0, "std": 1.0, "min": 0.0, "max": 0.0}
    ...
    def _fit_union(
        ...
        for feature in all_features:
            ...
            if values:
                ...
                self.feature_stats[feature] = {"mean": 0.0, "median": 0.0, "std": 1.0}
    ...
    def _fit_intersection(
        ...
        feature_sets = [set(df.columns) - {target_col} for df in datasets.values()]
        common_features = set.intersection(*feature_sets) if feature_sets else set()
        self.feature_schema = sorted(common_features)

    def transform(self, df: pd.DataFrame, target_col: str = "diagnosis") -> pd.DataFrame:
        """
    ...
    def _transform_embedding(self, df: pd.DataFrame, target_col: str) -> pd.DataFrame:
