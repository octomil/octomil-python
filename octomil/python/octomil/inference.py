...
class StreamingInferenceClient:
    ...
    def _make_chunk(
        self, raw_data: Any, modality: Modality, state: dict[str, Any]
    ) -> InferenceChunk:
    ...
    def _report_failure(
        self, model_id: str, version: str, modality: Modality, session_id: str
    ) -> None:
    ...
    def _finalize_session(
        self, model_id: str, version: str, modality: Modality, state: dict[str, Any]
    ) -> None:
